...
namespace Tesla.Gooding.Domain.AggregatesModel.BrandAggregates
{
    ...
    /// 品牌链接
    /// </summary>
    public class BrandUrl : Entity<Guid>, ITenantIdentity, IDeleteEntity, IOperateRecord, IAggregateRoot
    {
        #region Field
        ...
        /// 链接类型
        /// </summary>
        public BrandUrlType Type { get; private set; }
        ...
        public void Modify(long tenantId, string userId, string code, BrandUrlType type, string url)
        {
            this.Code = code;
            this.Type = type;
            this.Url = url;
